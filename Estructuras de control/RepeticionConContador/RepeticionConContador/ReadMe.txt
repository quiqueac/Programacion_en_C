========================================================================
    APLICACIÓN DE CONSOLA: RepeticionConContador Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación RepeticionConContador.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación RepeticionConContador.


RepeticionConContador.vcxproj
...
RepeticionConContador.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado RepeticionConContador.pch y un archivo de tipos precompilados llamado StdAfx.obj.
