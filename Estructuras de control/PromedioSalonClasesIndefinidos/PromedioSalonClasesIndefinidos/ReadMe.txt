========================================================================
    APLICACIÓN DE CONSOLA: PromedioSalonClasesIndefinidos Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación PromedioSalonClasesIndefinidos.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación PromedioSalonClasesIndefinidos.


PromedioSalonClasesIndefinidos.vcxproj
...
PromedioSalonClasesIndefinidos.vcxproj.filters
...
PromedioSalonClasesIndefinidos.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado PromedioSalonClasesIndefinidos.pch y un archivo de tipos precompilados llamado StdAfx.obj.
