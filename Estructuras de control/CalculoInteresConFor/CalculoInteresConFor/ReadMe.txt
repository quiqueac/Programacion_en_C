========================================================================
    APLICACIÓN DE CONSOLA: CalculoInteresConFor Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación CalculoInteresConFor.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación CalculoInteresConFor.


CalculoInteresConFor.vcxproj
...
CalculoInteresConFor.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado CalculoInteresConFor.pch y un archivo de tipos precompilados llamado StdAfx.obj.
