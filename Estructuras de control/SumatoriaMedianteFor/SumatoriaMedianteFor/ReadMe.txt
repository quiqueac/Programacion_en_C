========================================================================
    APLICACIÓN DE CONSOLA: SumatoriaMedianteFor Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación SumatoriaMedianteFor.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación SumatoriaMedianteFor.


SumatoriaMedianteFor.vcxproj
...
SumatoriaMedianteFor.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado SumatoriaMedianteFor.pch y un archivo de tipos precompilados llamado StdAfx.obj.
