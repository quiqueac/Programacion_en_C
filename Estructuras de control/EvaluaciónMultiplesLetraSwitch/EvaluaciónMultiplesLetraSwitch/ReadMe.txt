========================================================================
    APLICACIÓN DE CONSOLA: EvaluaciónMultiplesLetraSwitch Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación EvaluaciónMultiplesLetraSwitch.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación EvaluaciónMultiplesLetraSwitch.


EvaluaciónMultiplesLetraSwitch.vcxproj
...
EvaluaciónMultiplesLetraSwitch.vcxproj.filters
...
EvaluaciónMultiplesLetraSwitch.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado EvaluaciónMultiplesLetraSwitch.pch y un archivo de tipos precompilados llamado StdAfx.obj.
