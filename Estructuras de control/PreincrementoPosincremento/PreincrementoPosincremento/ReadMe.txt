========================================================================
    APLICACIÓN DE CONSOLA: PreincrementoPosincremento Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación PreincrementoPosincremento.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación PreincrementoPosincremento.


PreincrementoPosincremento.vcxproj
...
PreincrementoPosincremento.vcxproj.filters
...
PreincrementoPosincremento.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado PreincrementoPosincremento.pch y un archivo de tipos precompilados llamado StdAfx.obj.
