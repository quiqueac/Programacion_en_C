========================================================================
    APLICACIÓN DE CONSOLA: RepeticionForContador Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación RepeticionForContador.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación RepeticionForContador.


RepeticionForContador.vcxproj
...
RepeticionForContador.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado RepeticionForContador.pch y un archivo de tipos precompilados llamado StdAfx.obj.
