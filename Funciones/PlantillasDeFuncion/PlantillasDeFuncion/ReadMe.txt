========================================================================
    APLICACIÓN DE CONSOLA: PlantillasDeFuncion Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación PlantillasDeFuncion.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación PlantillasDeFuncion.


PlantillasDeFuncion.vcxproj
...
PlantillasDeFuncion.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado PlantillasDeFuncion.pch y un archivo de tipos precompilados llamado StdAfx.obj.
