========================================================================
    APLICACIÓN DE CONSOLA: FuncionesSinArgumentos Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación FuncionesSinArgumentos.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación FuncionesSinArgumentos.


FuncionesSinArgumentos.vcxproj
...
FuncionesSinArgumentos.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado FuncionesSinArgumentos.pch y un archivo de tipos precompilados llamado StdAfx.obj.
