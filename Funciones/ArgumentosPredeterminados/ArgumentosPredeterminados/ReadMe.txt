========================================================================
    APLICACIÓN DE CONSOLA: ArgumentosPredeterminados Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación ArgumentosPredeterminados.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación ArgumentosPredeterminados.


ArgumentosPredeterminados.vcxproj
...
ArgumentosPredeterminados.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado ArgumentosPredeterminados.pch y un archivo de tipos precompilados llamado StdAfx.obj.
