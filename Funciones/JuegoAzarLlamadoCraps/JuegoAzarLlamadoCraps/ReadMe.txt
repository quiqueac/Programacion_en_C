========================================================================
    APLICACIÓN DE CONSOLA: JuegoAzarLlamadoCraps Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación JuegoAzarLlamadoCraps.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación JuegoAzarLlamadoCraps.


JuegoAzarLlamadoCraps.vcxproj
...
JuegoAzarLlamadoCraps.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado JuegoAzarLlamadoCraps.pch y un archivo de tipos precompilados llamado StdAfx.obj.
