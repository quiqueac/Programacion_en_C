========================================================================
    APLICACIÓN DE CONSOLA: PasoDeArgumentosPorValorYReferencia Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación PasoDeArgumentosPorValorYReferencia.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación PasoDeArgumentosPorValorYReferencia.


PasoDeArgumentosPorValorYReferencia.vcxproj
...
PasoDeArgumentosPorValorYReferencia.vcxproj.filters
...
PasoDeArgumentosPorValorYReferencia.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado PasoDeArgumentosPorValorYReferencia.pch y un archivo de tipos precompilados llamado StdAfx.obj.
