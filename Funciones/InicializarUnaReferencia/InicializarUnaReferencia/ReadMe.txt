========================================================================
    APLICACIÓN DE CONSOLA: InicializarUnaReferencia Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación InicializarUnaReferencia.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación InicializarUnaReferencia.


InicializarUnaReferencia.vcxproj
...
InicializarUnaReferencia.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado InicializarUnaReferencia.pch y un archivo de tipos precompilados llamado StdAfx.obj.
