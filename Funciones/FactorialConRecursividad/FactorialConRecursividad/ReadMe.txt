========================================================================
    APLICACIÓN DE CONSOLA: FactorialConRecursividad Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación FactorialConRecursividad.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación FactorialConRecursividad.


FactorialConRecursividad.vcxproj
...
FactorialConRecursividad.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado FactorialConRecursividad.pch y un archivo de tipos precompilados llamado StdAfx.obj.
