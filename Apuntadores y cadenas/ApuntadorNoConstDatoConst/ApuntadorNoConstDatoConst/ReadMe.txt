========================================================================
    APLICACIÓN DE CONSOLA: ApuntadorNoConstDatoConst Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación ApuntadorNoConstDatoConst.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación ApuntadorNoConstDatoConst.


ApuntadorNoConstDatoConst.vcxproj
...
ApuntadorNoConstDatoConst.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado ApuntadorNoConstDatoConst.pch y un archivo de tipos precompilados llamado StdAfx.obj.
