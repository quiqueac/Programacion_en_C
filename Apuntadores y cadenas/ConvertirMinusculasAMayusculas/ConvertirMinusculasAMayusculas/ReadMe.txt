========================================================================
    APLICACIÓN DE CONSOLA: ConvertirMinusculasAMayusculas Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación ConvertirMinusculasAMayusculas.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación ConvertirMinusculasAMayusculas.


ConvertirMinusculasAMayusculas.vcxproj
...
ConvertirMinusculasAMayusculas.vcxproj.filters
...
ConvertirMinusculasAMayusculas.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado ConvertirMinusculasAMayusculas.pch y un archivo de tipos precompilados llamado StdAfx.obj.
