========================================================================
    APLICACIÓN DE CONSOLA: OrdenamientoBurbuja Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación OrdenamientoBurbuja.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación OrdenamientoBurbuja.


OrdenamientoBurbuja.vcxproj
...
OrdenamientoBurbuja.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado OrdenamientoBurbuja.pch y un archivo de tipos precompilados llamado StdAfx.obj.
