========================================================================
    APLICACIÓN DE CONSOLA: ApuntadorConstDatoConst Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación ApuntadorConstDatoConst.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación ApuntadorConstDatoConst.


ApuntadorConstDatoConst.vcxproj
...
ApuntadorConstDatoConst.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado ApuntadorConstDatoConst.pch y un archivo de tipos precompilados llamado StdAfx.obj.
