========================================================================
    APLICACIÓN DE CONSOLA: ArregloDeApuntadoresAFunciones Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación ArregloDeApuntadoresAFunciones.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación ArregloDeApuntadoresAFunciones.


ArregloDeApuntadoresAFunciones.vcxproj
...
ArregloDeApuntadoresAFunciones.vcxproj.filters
...
ArregloDeApuntadoresAFunciones.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado ArregloDeApuntadoresAFunciones.pch y un archivo de tipos precompilados llamado StdAfx.obj.
