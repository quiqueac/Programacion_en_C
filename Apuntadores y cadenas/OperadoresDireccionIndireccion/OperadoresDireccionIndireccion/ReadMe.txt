========================================================================
    APLICACIÓN DE CONSOLA: OperadoresDireccionIndireccion Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación OperadoresDireccionIndireccion.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación OperadoresDireccionIndireccion.


OperadoresDireccionIndireccion.vcxproj
...
OperadoresDireccionIndireccion.vcxproj.filters
...
OperadoresDireccionIndireccion.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado OperadoresDireccionIndireccion.pch y un archivo de tipos precompilados llamado StdAfx.obj.
