========================================================================
    APLICACIÓN DE CONSOLA: OrdenamientoBurbujaMultipro Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación OrdenamientoBurbujaMultipro.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación OrdenamientoBurbujaMultipro.


OrdenamientoBurbujaMultipro.vcxproj
...
OrdenamientoBurbujaMultipro.vcxproj.filters
...
OrdenamientoBurbujaMultipro.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado OrdenamientoBurbujaMultipro.pch y un archivo de tipos precompilados llamado StdAfx.obj.
