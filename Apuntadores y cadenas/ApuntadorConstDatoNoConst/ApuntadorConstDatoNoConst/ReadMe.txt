========================================================================
    APLICACIÓN DE CONSOLA: ApuntadorConstDatoNoConst Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación ApuntadorConstDatoNoConst.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación ApuntadorConstDatoNoConst.


ApuntadorConstDatoNoConst.vcxproj
...
ApuntadorConstDatoNoConst.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado ApuntadorConstDatoNoConst.pch y un archivo de tipos precompilados llamado StdAfx.obj.
