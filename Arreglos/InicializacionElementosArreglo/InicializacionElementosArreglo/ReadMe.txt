========================================================================
    APLICACIÓN DE CONSOLA: InicializacionElementosArreglo Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación InicializacionElementosArreglo.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación InicializacionElementosArreglo.


InicializacionElementosArreglo.vcxproj
...
InicializacionElementosArreglo.vcxproj.filters
...
InicializacionElementosArreglo.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado InicializacionElementosArreglo.pch y un archivo de tipos precompilados llamado StdAfx.obj.
