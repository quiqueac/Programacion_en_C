========================================================================
    APLICACIÓN DE CONSOLA: InicializacionMatrices Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación InicializacionMatrices.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación InicializacionMatrices.


InicializacionMatrices.vcxproj
...
InicializacionMatrices.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado InicializacionMatrices.pch y un archivo de tipos precompilados llamado StdAfx.obj.
