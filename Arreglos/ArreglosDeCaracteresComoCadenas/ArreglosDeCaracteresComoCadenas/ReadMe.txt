========================================================================
    APLICACIÓN DE CONSOLA: ArreglosDeCaracteresComoCadenas Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación ArreglosDeCaracteresComoCadenas.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación ArreglosDeCaracteresComoCadenas.


ArreglosDeCaracteresComoCadenas.vcxproj
...
ArreglosDeCaracteresComoCadenas.vcxproj.filters
...
ArreglosDeCaracteresComoCadenas.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado ArreglosDeCaracteresComoCadenas.pch y un archivo de tipos precompilados llamado StdAfx.obj.
