========================================================================
    APLICACIÓN DE CONSOLA: FrecuenciaCarasDado6000VecesArreglo Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación FrecuenciaCarasDado6000VecesArreglo.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación FrecuenciaCarasDado6000VecesArreglo.


FrecuenciaCarasDado6000VecesArreglo.vcxproj
...
FrecuenciaCarasDado6000VecesArreglo.vcxproj.filters
...
FrecuenciaCarasDado6000VecesArreglo.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado FrecuenciaCarasDado6000VecesArreglo.pch y un archivo de tipos precompilados llamado StdAfx.obj.
