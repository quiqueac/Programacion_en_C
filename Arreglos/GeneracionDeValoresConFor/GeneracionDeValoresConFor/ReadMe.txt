========================================================================
    APLICACIÓN DE CONSOLA: GeneracionDeValoresConFor Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación GeneracionDeValoresConFor.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación GeneracionDeValoresConFor.


GeneracionDeValoresConFor.vcxproj
...
GeneracionDeValoresConFor.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado GeneracionDeValoresConFor.pch y un archivo de tipos precompilados llamado StdAfx.obj.
