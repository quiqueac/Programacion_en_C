========================================================================
    APLICACIÓN DE CONSOLA: ManipulacionMatrices Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación ManipulacionMatrices.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación ManipulacionMatrices.


ManipulacionMatrices.vcxproj
...
ManipulacionMatrices.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado ManipulacionMatrices.pch y un archivo de tipos precompilados llamado StdAfx.obj.
