========================================================================
    APLICACIÓN DE CONSOLA: SumaElementosArreglo Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación SumaElementosArreglo.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación SumaElementosArreglo.


SumaElementosArreglo.vcxproj
...
SumaElementosArreglo.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado SumaElementosArreglo.pch y un archivo de tipos precompilados llamado StdAfx.obj.
