========================================================================
    APLICACIÓN DE CONSOLA: InicializaciónCerosElementosArreglo Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación InicializaciónCerosElementosArreglo.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación InicializaciónCerosElementosArreglo.


InicializaciónCerosElementosArreglo.vcxproj
...
InicializaciónCerosElementosArreglo.vcxproj.filters
...
InicializaciónCerosElementosArreglo.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado InicializaciónCerosElementosArreglo.pch y un archivo de tipos precompilados llamado StdAfx.obj.
