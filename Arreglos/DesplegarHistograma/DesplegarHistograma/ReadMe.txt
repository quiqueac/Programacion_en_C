========================================================================
    APLICACIÓN DE CONSOLA: DesplegarHistograma Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación DesplegarHistograma.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación DesplegarHistograma.


DesplegarHistograma.vcxproj
...
DesplegarHistograma.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado DesplegarHistograma.pch y un archivo de tipos precompilados llamado StdAfx.obj.
