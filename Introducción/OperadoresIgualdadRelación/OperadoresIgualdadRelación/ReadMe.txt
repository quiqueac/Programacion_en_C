========================================================================
    APLICACIÓN DE CONSOLA: OperadoresIgualdadRelación Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación OperadoresIgualdadRelación.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación OperadoresIgualdadRelación.


OperadoresIgualdadRelación.vcxproj
...
OperadoresIgualdadRelación.vcxproj.filters
...
OperadoresIgualdadRelación.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado OperadoresIgualdadRelación.pch y un archivo de tipos precompilados llamado StdAfx.obj.
